...
public class ConsultaCodigoPostalResponse implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://www.example.org/Pr1/", "consultaCodigoPostalResponse", "ns1");
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if (serializeType) {
			...
			java.lang.String namespacePrefix = registerPrefix(xmlWriter, "http://www.example.org/Pr1/");
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":consultaCodigoPostalResponse", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						"consultaCodigoPostalResponse", xmlWriter);
			}
	...
	private static java.lang.String generatePrefix(java.lang.String namespace) {
		if (namespace.equals("http://www.example.org/Pr1/")) {
			return "ns1";
		}
	...
	public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
		...
		elementList.add(new javax.xml.namespace.QName("", "codigoPostal"));
		...
		elementList.add(new javax.xml.namespace.QName("", "poblacion"));
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static ConsultaCodigoPostalResponse parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			ConsultaCodigoPostalResponse object = new ConsultaCodigoPostalResponse();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"consultaCodigoPostalResponse".equals(type)) {
							...
							return (ConsultaCodigoPostalResponse) org.example.www.pr1.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("", "codigoPostal").equals(reader.getName())) {

					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						throw new org.apache.axis2.databinding.ADBException(
								"The element: " + "codigoPostal" + "  cannot be null");
					}

					java.lang.String content = reader.getElementText();

					object.setCodigoPostal(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("", "poblacion").equals(reader.getName())) {

					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						throw new org.apache.axis2.databinding.ADBException(
								"The element: " + "poblacion" + "  cannot be null");
					}

					java.lang.String content = reader.getElementText();

					object.setPoblacion(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
