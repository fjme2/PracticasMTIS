...
public class MySQL {
    ...
    public float getPrecio(String referencia){
    	float precio = 0;
    	
    	try {
    		//falta la referencia en la query
    ...
    public int devolverStock(String referencia){
    	int stock = 0;
    	try {
    		//falta la referencia en la query
    		String Query = "SELECT * FROM productos where referencia=\""+referencia+"\"";
    ...
    public boolean actualizarStock(String referencia, int cantidad){
    	
    	int stock = devolverStock(referencia);
    	int newstock = stock - cantidad;
    	try {
            String Query = "Update productos set stock=" + newstock + " where referencia=\""+referencia+"\"";
            System.out.println(Query);
            Statement st = Conexion.createStatement();
            st.executeUpdate(Query);
